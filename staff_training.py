responsepair = [
    ...
    [ r"what is your name?|who are you?", ["I am a chatbot, my name is Nerd because I know things",]],
    ...
    [ r"can you tell me about honorary|honorary|honorary appointments",["There is alot of information I can tell you about an Honorary appointment. They are normally offered to individuals not normally employed by the University. \nRecommendations are submitted by the Head of School",]],
    [ r"can you tell me about casual|casual|casual appointments",["Casual contracts are initiated through the online casual hire for a maximum of 12 months (the system will not allow a longer period) casual teaching are initiated by school operations, staff resources create the casual general contracts.",]],
    [ r"can you tell me about fixed-term|fixed-term appointments|fixed-term",["Fixed-term appointments less then 2 years are not required to be advertised, research grants that name the applicant are exempt from advertisement.",]],
    [ r"can you tell me about ongoing|ongoing|ongoing appointments",["Ongoing appointments will need to be initiated through eRecruitment, ensure you have business case and postion description and submit as per the HR delegations",]],
